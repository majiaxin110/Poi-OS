...
#define ANIMATION_DELAY_TIME 2000
...
// open OS animation
	int count = 8;
	while(count){
		printf("BBBBBBBBBBBBBPs7sqBBBQBBBBBBBBBQBBBQBBBB\n");
		...
		printf("QBBBBBBBBBBBBBBBBBQBQBB SBBBBBBBBBBBQBBB\n");
		milli_delay(ANIMATION_DELAY_TIME);	
		clear_screen(&(console_table[0]));
		...
		printf("BBBQBBBBBBBBBQBBBBBBBBB BBBBBBBBBBBBBBBB\n");
		printf("QBBBQBBBBBQBBBBBBBBBBBP QBBBBBBBQBBBBBBB\n");
		milli_delay(ANIMATION_DELAY_TIME);	
		clear_screen(&(console_table[0]));
		...
		printf("BBBBBBBBB  BBBBBBBBBBBB 2BBBBBBBBBBBBBBB\n");
		printf("QBBBBBBBi BBBBBBBBBBBBB bBBBBBBBQBQBBBQB\n");
		printf("BBBBBBBQ vBBBBBBBBBBBBB QBBBBBBQBQBBBBBQ\n");
		printf("QBQBQBBBBBQBBBQBBBBBBBb QBQBBBBBBBBBBBBB\n");
		milli_delay(ANIMATION_DELAY_TIME);	
		clear_screen(&(console_table[0]));
		printf("BBBBBBBBBBBBBBBQBQ:BBr     iBQBBBBBBBBBB\n");
		printf("QBBBBBBBBBBBBBBBBBi  .IBQBP. LBBBBBBBBBB\n");
		printf("BQBBBBBQBBBBBQBBBB7 BBBBBQBBB UQBBBBBBBB\n");
		printf("QBQBQBBBQBBBBBBBBg Bq.BBQBBiBE BBBBBBBBB\n");
		printf("BQBBBBBBBBBBBBBBBv BK BBBBB UQ BBBBBBBBB\n");
		printf("QBQBBBQBBBBBBBQBBd BQBQU LQBBi BBBBBQBBB\n");
		printf("BBBBBBBBBBBBBBBQBB. BBBBBBBB7 MBBBBBBBBQ\n");
		printf("QBBBBBBBBBEBBBBBBBBU  7bDP7 .BQBBBBBBBBB\n");
		printf("BQBBBBBBBb        .r  i...  r:..... .  :\n");
		printf("QBBBBBBBBBBBQBBBBBQS BBBBBv BMddPdPPPPKB\n");
		printf("BQBBBBBBBQBBBBBBBBB gBBBBB:.BBBQBBBBBBBB\n");
		printf("QBBBBBBBBBBBQBBBBB iBBQBBB iBBQBQBBBBBBB\n");
		printf("BBBBBBBBBBBBBBBBB. BBBBBBB vBBBBBBBBBBBB\n");
		printf("QBBBBBBBBBBBBBBBs BBBBQBQB PQBBBBBBBBBBB\n");
		printf("BQBBBBBQBBBBBBBQ ZBBBBBBBB MBBBBBBBBBBBB\n");
		printf("QBBBBBQBBBBBBBQ rBBBQBQBBB BBBBBBBBBQBBB\n");
		printf("BBBBBBBBBBBBBB .BBBBBQBBBb BBBBBBBBBBBBB\n");
		printf("QBBBBBBBQBBBBg gBBBBBBBBB2 BBBQBBBBBBBBB\n");
		printf("BBBBBBBBBBBBBB.  rQBBQBBB7 BBBBBBBBBBQBB\n");
		printf("QBBBBBBBBBQBBB BM:  .ruMg  BBBBBBBBBBBBB\n");
		printf("BBBBBBBBBBBBB .BBBBQ1ii  :EBBQBBBBBBBBBB\n");
		printf("QBBBBBBBBBBBZ BBBBBBBBB qBBBBBBBBBBBQBBB\n");
		printf("BBBBBBBBBBBB rBBBQBBBBB bBBBBBBBBBBQBBBB\n");
		printf("QBBBBBQBQBBI BBBBBQBBBB ZBBBBBBBBBQBBBBB\n");
		printf("BBBQBBBBBBB 1BBBBBBBBBB BQBBBBBBBBBBBBBQ\n");
		printf("QBBBBBBBBB: BBBBBBBBQBB BBBBBBBBBBBBBBBB\n");
		printf("BBBQBBBBBB RBBBBBBBBBBB BBBBBQBBBBBBBBBB\n");
		printf("QBBBBBBBj :BBBBBBBBBBBb BBBBBBBBBBBBBBBB\n");
		milli_delay(ANIMATION_DELAY_TIME);	
		clear_screen(&(console_table[0]));
		printf("QBQBBBBBBBBBBBBBBB.ug:  ..   QBBBBBBBBBB\n");
		printf("BBBBBBBBBBBQBBBQBQQ  rBBBBBQv KBBBBBBBBB\n");
		printf("QBBBBBQBBBBBQBQBBBq BBBBBBBBQP BBBBBQBBB\n");
		printf("BBBQBBBBBBBBBBBBBQ 1B uBBBBg Q jBBBBBBBQ\n");
		printf("QBBBBBBBBBBBBBBBQB gBBBBL7BBPB 2BBBBBBBB\n");
		printf("BBBBBBBBBBBQBBBBBB: BBBBv:BQBi BBBBBBBBB\n");
		printf("QBBBBBQBBBBBQBBBBBBL IQBBBQR  BBBBBBBBBB\n");
		printf("BBBBBBBBBQ i77YvsYIgY   ..  :BBQRgDddK22\n");
		printf("QBQBBBBBBBJ7rrirr7vU rBBgQv .:.. ..... 7\n");
		printf("BBBBBBBBBBBBBQBBBBB: BBBBBB BQBBBBBBBBBB\n");
		printf("QBBBBBBBBBBBQBBBBBi BBBBBBX QBBBBBBBBBBB\n");
		printf("BBBBBBBBBBBBBQBBBI BBBBBBBY BQBBBBBBBBBB\n");
		printf("QBBBBBBBQBBBBBQBQ PBBBBBBBr BBBBBBBBBBQB\n");
		printf("BBBBBBBBBBBBBBBB rBBBBBBBB. BBBBBBBBBQBB\n");
		printf("QBBBQBBBBBBBQBB  BBBBBQBBB rBBBBBBBBBBBB\n");
		printf("BQBBBBBBBBBBBBr BBBBBQBBBB uBBBBBBBBBBBB\n");
		printf("QBQBBBBBBBBBBX BBBBBBBQBBB gBBBBBBBBBBBB\n");
		printf("BBBBBBBBBQBBBB. rgBBBBBBBB QBBBBBBBBBBBB\n");
		printf("QBBBBBBBBBBBBB 27  .i2EBBv BQBBBBBBBBBBB\n");
		printf("BBBBBBBBBQBBB :QBBBI7:.  .vBBBBBBBBBBQBB\n");
		printf("QBBBBBBBQBBB7 BBBBQBBBB jBQBBBBBBBQBBBBB\n");
		printf("BBBBBBBQBBBQ gBBBBBBBBB YQBBBBBBBQBBBBBB\n");
		printf("QBBBBBBBBBB .BBBBBQBBBB JBBBBBBBBBBBQBBB\n");
		printf("BBBBBBBBBBQ BBBBBBBBBBB qBBBBBBBBQBBBBBQ\n");
		printf("QBBBQBQBBB :BBQBBBBBQBB gBBBBBBBBBBBBBBB\n");
		printf("BBBBBBBBBd BBBBBBBBQBBB BBBBBQBBBBBBBBBQ\n");
		printf("QBBBBBBBq iBBBBBQBBBBBP BBBBBBBBBBBBQBBB\n");
		milli_delay(ANIMATION_DELAY_TIME);	
		clear_screen(&(console_table[0]));
		...
		printf("BBBQBBBBBBBBBBBBBBBQBBB QBBBBBBQBBBBBBBB\n");
		printf("BBBBQBQBBBBBBBBBBBQBBBK BBBBBBBBQBQBBBBB\n");
		milli_delay(ANIMATION_DELAY_TIME);	
		clear_screen(&(console_table[0]));
		printf("QBBBBBBBQBBBBBBY.. .iRBBQBQBBBBBBBQBBBQB\n");
		printf("BBBBBBBBBBg:B. :UPE5i .BBBBQBBBBBBBBBBBB\n");
